...
#given conditions for sum of digits 14 and 'number obtained by interchanging digits exceeds given by 18'
A = np.array([[1, 1],
              [1, -1]])
B = np.array([14, -2])
...
#if using termux
plt.savefig('/home/krishna/Documents/Matgeo-assignments/figs/10-26.pdf')
