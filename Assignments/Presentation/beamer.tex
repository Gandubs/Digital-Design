...
\begin{align}
u_{\brak{n-1}} &\xrightarrow{\mathcal{Z}} \frac{z^{-1}}{1-z^{-1}} \label{21}
\end{align}
...
(n-1)u_{\brak{n-1}}    &\xrightarrow{\mathcal{Z}} \frac{z^{-2}}{\brak{1-z^{-1}}^{2}} \label{22}
\end{align}
...
Using $\eqref{shift}$
\begin{align}
    \frac{(n-1)(n-2)u_{\brak{n-2}}}{2}    &\xrightarrow{\mathcal{Z}} \frac{z^{-3}}{\brak{1-z^{-1}}^3} \label{23} 
\end{align}
\end{frame}
...
\begin{align}
   y(n) &= 8u_{\brak{n-1}} + 10(n-1)u_{\brak{n-1}} + 4\frac{(n-1)(n-2)u_{\brak{n-2}}}{2} +2\delta(n)
\end{align}
Putting $n=19$
\begin{align}
      y(19) &= 2(19+1)^2 = 800
...
\begin{align}
   y(n) = (2x_0+d)u_{\brak{n-1}} &+ (n-1)u_{\brak{n-1}}(x_0+2d) + \notag\\
    &\frac{d(n-1)(n-2)u_{\brak{n-2}}}{2} + x(0)\delta(n)
\end{align}
